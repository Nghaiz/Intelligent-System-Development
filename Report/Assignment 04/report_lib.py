...
<div class="cover">{frame_img}
  <div class="inner">
    ...
    {logo_img}
    <div class="title">BÁO CÁO ASSIGNMENT 04</div>
    <div class="subject">ĐỀ TÀI: CONVOLUTIONAL NEURAL NETWORKS<br>TỪ TÍCH CHẬP TOÁN HỌC ĐẾN NUMPY, PYTORCH VÀ TENSORFLOW</div>
    ...
    def build(self, page_numbers: dict[str, int] | None = None) -> str:
        return (f"<!doctype html><html lang=\"vi\"><head><meta charset=\"utf-8\">"
                f"<title>Báo cáo Assignment 04 — {STUDENT['ten']}</title>"
